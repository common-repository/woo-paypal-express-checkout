...
if (!class_exists('Pal_Express_Checkout_For_Woo_Calculations')) {
    ...
    class Pal_Express_Checkout_For_Woo_Calculations {
        ...
        public function cart_calculation() {
            ...
            foreach (WC()->cart->get_fees() as $cart_item_key => $fee_values) {
                $fee_item = array(
                    ...
                    'desc' => '',
                    'qty' => 1,
                    'amt' => pal_number_format($fee_values->amount),
                    'number' => ''
                );
            ...
            if ($this->itemamt == $this->discount_amount) {
                ...
                if ($this->discount_amount > 0) {
                    $discLineItem = array(
                        ...
                        'qty' => 1,
                        'number' => '',
                        'amt' => '-' . pal_number_format($this->discount_amount)
                    );
            ...
            $this->payment['itemamt'] = pal_number_format(round($this->itemamt, $this->decimals));
            $this->payment['taxamt'] = pal_number_format(round($this->taxamt, $this->decimals));
            $this->payment['shippingamt'] = pal_number_format(round($this->shippingamt, $this->decimals));
            $this->payment['order_items'] = $this->order_items;
            $this->payment['discount_amount'] = pal_number_format(round($this->discount_amount, $this->decimals));
            return $this->payment;
        }
